...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-bs-theme="auto">
    <head>
        <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=DVJnlg_YfrL_z5msjlC36h_VVpPghENZcFUWejxKciUnCYmxHM0NIwM51JkeIiSYTTQEr6tfx8FYJSbu5BDRVJk2GLDCc04u2cZt-jb4-qdvvYi8wK3rVrj1jcuEJjgQ" charset="UTF-8"></script><script src="../assets/js/color-modes.js"></script>

        <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=OkvT2sJfduUHnLI9DoQH9AFTP30Wovj2KLJ8n4bTHCLwF1oIgjmIhMlxgEpRDXkFhsa_Of00ui_k_37X8Aore1bJwkSCx16PbOvL_Q0HO_vW6NG3EPWKMQ3-aEuCRvoI" charset="UTF-8"></script><script src="../assets/js/color-modes.js"></script>
